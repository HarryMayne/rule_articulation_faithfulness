##########################################################################################
# utils.py: using my standard llm client factory but with openai only. might consider vllm models if time and server fixed...
...
# (Copied from previous projects) -> Just use OAI implementation for ease...
################################################################################################################################################################################################
